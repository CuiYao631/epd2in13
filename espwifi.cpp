...
******************************************************/
bool espwifi::AutoConfigWifi(void){
WiFi.mode(WIFI_STA);
  WiFi.begin();
...
//断开连接
void espwifi::BreakOffWifi(void){

};
//恢复出厂
void espwifi::Recovery(void){
 ...
 * 参数说明：无
******************************************************/
void espwifi::HandleNotFound(void){
